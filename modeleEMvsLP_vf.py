...
trainingLabels   = df.loc[:, "EMvsLP"].as_matrix()
...
# On ne test que pour EMvsLP = 1 ou 0
testingFeatures = np.array(dftest.loc[dftest["EMvsLP"]<2, "txCleanNumber"].tolist())
...
testingLabels   = dftest.loc[dftest["EMvsLP"]<2, "EMvsLP"].as_matrix()
...
model.save('polarity_rnn_with_cnn.h5')
...
dftest.loc[dftest["EMvsLP"]<2, "pred"] = pred

print dftest.loc[dftest["pred"]<2, ["EMvsLP", "pred"]]
